function result = batchnormal3(inDir, outDir)
%batchbatchnormal Batch process images using batchnormal
% RESULT = batchbatchnormal(INDIR, OUTDIR) processes each file in INDIR
% using the function batchnormal.
%
% The following fields from the output of batchnormal are written with their
% corresponding file format to the output directory OUTDIR:
%    img saved as png format
%
...
% Process each image using batchnormal
